...
- 	Если после байта счёта файлов или папок стоит больше одного указателя заголовка файла или папки, то следующие файлы или папки будут иметь ID n = указатель счёта + 1 + ID n-1   
