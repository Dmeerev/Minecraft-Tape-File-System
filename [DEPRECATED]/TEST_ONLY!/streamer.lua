...
local convertNS = require("streamerLib")
...
local function printUsage()
  ...
  print(" - 'tape read <path to save> to save files from tape to disk")
  print("Other options:")
...
local function taperead()
  ...
  tape.read()
  tape.seek(-1)
  local readbytes = tape.read() 
  print(readbytes)
  local convbytes = convertNS.fromDec(readbytes, 16)
  print(convbytes)  
